...
public class AddModifyTask extends AppCompatActivity {
    ...
    public void saveTask(View v) {
        ...
        if (edit_text.getText().toString().trim().length() > 0) {
            ...
            if (isModify) {
                ...
                Toast.makeText(getApplicationContext(), "Sarcina actualizata.", Toast.LENGTH_SHORT).show();
            } else {
                mydb.insertTask(edit_text.getText().toString(), new SimpleDateFormat("yyyy-MM-dd").format(calendar.getTime()));
                Toast.makeText(getApplicationContext(), "Sarcina adaugata.", Toast.LENGTH_SHORT).show();
            }
            finish();

        } else {
            Toast.makeText(getApplicationContext(), "Sarcina este goala si nu poate fi actualizata.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void deleteTask(View v) {
        ...
        Toast.makeText(getApplicationContext(), "Sarcina eliminata", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    public void chooseDate(View view) {
        ...
        builder.setTitle("Alege o data");
        builder.setNegativeButton("Anulare", null);
        builder.setPositiveButton("Seteaza", new DialogInterface.OnClickListener() {
